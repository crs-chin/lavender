...
pkgdatadir = $(datadir)/lavender
pkgincludedir = $(includedir)/lavender
pkglibdir = $(libdir)/lavender
pkglibexecdir = $(libexecdir)/lavender
...
libdesert_la_LIBADD =
am_libdesert_la_OBJECTS = libdesert_la-desert.lo \
	libdesert_la-ipclite.lo libdesert_la-ipclite_client.lo \
	libdesert_la-rpclite.lo
libdesert_la_OBJECTS = $(am_libdesert_la_OBJECTS)
libdesert_la_LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(libdesert_la_CFLAGS) \
	$(CFLAGS) $(AM_LDFLAGS) $(LDFLAGS) -o $@
am__DEPENDENCIES_1 =
libdesert_gtk_la_DEPENDENCIES = $(am__DEPENDENCIES_1)
am_libdesert_gtk_la_OBJECTS = libdesert_gtk_la-desert_gtk.lo
libdesert_gtk_la_OBJECTS = $(am_libdesert_gtk_la_OBJECTS)
libdesert_gtk_la_LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(libdesert_gtk_la_CFLAGS) \
	$(CFLAGS) $(AM_LDFLAGS) $(LDFLAGS) -o $@
PROGRAMS = $(bin_PROGRAMS) $(sbin_PROGRAMS)
am_lavender_OBJECTS = lavender-lavender.$(OBJEXT)
lavender_OBJECTS = $(am_lavender_OBJECTS)
lavender_DEPENDENCIES = cactus/libcactus.la
lavender_LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) \
	--mode=link $(CCLD) $(lavender_CFLAGS) $(CFLAGS) $(AM_LDFLAGS) \
	$(LDFLAGS) -o $@
am_lavender_gtk_OBJECTS = lavender_gtk-lavender-gtk.$(OBJEXT)
lavender_gtk_OBJECTS = $(am_lavender_gtk_OBJECTS)
lavender_gtk_DEPENDENCIES = libdesert.la libdesert_gtk.la \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1)
lavender_gtk_LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(lavender_gtk_CFLAGS) \
	$(CFLAGS) $(AM_LDFLAGS) $(LDFLAGS) -o $@
am_lotus_OBJECTS = lotus-lotus.$(OBJEXT)
lotus_OBJECTS = $(am_lotus_OBJECTS)
lotus_DEPENDENCIES = libdesert.la
lotus_LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) \
	--mode=link $(CCLD) $(lotus_CFLAGS) $(CFLAGS) $(AM_LDFLAGS) \
	$(LDFLAGS) -o $@
...
LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) \
	...
	$(LDFLAGS) -o $@
SOURCES = $(libdesert_la_SOURCES) $(libdesert_gtk_la_SOURCES) \
	$(lavender_SOURCES) $(lavender_gtk_SOURCES) $(lotus_SOURCES)
DIST_SOURCES = $(libdesert_la_SOURCES) $(libdesert_gtk_la_SOURCES) \
	$(lavender_SOURCES) $(lavender_gtk_SOURCES) $(lotus_SOURCES)
...
NM = /usr/bin/nm -B
NMEDIT = 
NOTIFY_CFLAGS = -pthread -I/usr/include/gtk-2.0 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/dbus-1.0 -I/usr/lib/dbus-1.0/include -I/usr/lib/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/pango-1.0 -I/usr/include/gio-unix-2.0/ -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12  
NOTIFY_LIBS = -pthread -L/lib -lnotify -lgtk-x11-2.0 -ldbus-glib-1 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lm -lcairo -lpng12 -lpango-1.0 -lfreetype -lfontconfig -lgmodule-2.0 -ldbus-1 -lpthread -lgobject-2.0 -lgthread-2.0 -lrt -lglib-2.0  
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
OTOOL64 = 
PACKAGE = lavender
PACKAGE_BUGREPORT = crs.chin@gmail.com
PACKAGE_NAME = lavender
PACKAGE_STRING = lavender 0.2.0
PACKAGE_TARNAME = lavender
PACKAGE_URL = 
...
libdesert.la: $(libdesert_la_OBJECTS) $(libdesert_la_DEPENDENCIES) 
	$(libdesert_la_LINK) -rpath $(libdir) $(libdesert_la_OBJECTS) $(libdesert_la_LIBADD) $(LIBS)
libdesert_gtk.la: $(libdesert_gtk_la_OBJECTS) $(libdesert_gtk_la_DEPENDENCIES) 
	$(libdesert_gtk_la_LINK) -rpath $(libdir) $(libdesert_gtk_la_OBJECTS) $(libdesert_gtk_la_LIBADD) $(LIBS)
...
clean-sbinPROGRAMS:
	...
	echo " rm -f" $$list; \
	rm -f $$list
lavender$(EXEEXT): $(lavender_OBJECTS) $(lavender_DEPENDENCIES) 
	@rm -f lavender$(EXEEXT)
	$(lavender_LINK) $(lavender_OBJECTS) $(lavender_LDADD) $(LIBS)
lavender-gtk$(EXEEXT): $(lavender_gtk_OBJECTS) $(lavender_gtk_DEPENDENCIES) 
	@rm -f lavender-gtk$(EXEEXT)
	$(lavender_gtk_LINK) $(lavender_gtk_OBJECTS) $(lavender_gtk_LDADD) $(LIBS)
lotus$(EXEEXT): $(lotus_OBJECTS) $(lotus_DEPENDENCIES) 
	@rm -f lotus$(EXEEXT)
	$(lotus_LINK) $(lotus_OBJECTS) $(lotus_LDADD) $(LIBS)
...
install-extraDATA: $(extra_DATA)
	@$(NORMAL_INSTALL)
	test -z "$(extradir)" || $(MKDIR_P) "$(DESTDIR)$(extradir)"
	@list='$(extra_DATA)'; test -n "$(extradir)" || list=; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
	done | $(am__base_list) | \
...
installdirs-am:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(bindir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(extradir)"; do \
...
install-data-am: install-extraDATA
...
uninstall-am: uninstall-binPROGRAMS uninstall-extraDATA \
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-dvi-am install-exec install-exec-am install-extraDATA \
	...
	uninstall-binPROGRAMS uninstall-extraDATA \
	uninstall-libLTLIBRARIES uninstall-sbinPROGRAMS \
	uninstall-sbinSCRIPTS
